...
class Car(pygame.sprite.Sprite):
    def __init__(self, pos, image_path, controls, angle=255):
        super().__init__()
...
# Assets
track_surface = scale_image(pygame.image.load("assets/usa.png").convert_alpha(), 2.9)
border_surface = scale_image(pygame.image.load("assets/usa_border.png").convert_alpha(), 2.9)
drs_surface = scale_image(pygame.image.load("assets/usa_drs.png").convert_alpha(), 2.9)
finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 255)
...
finish_rect = finish_img.get_rect(center=(1793, 5755))

# Players
player1 = Car((2004, 5859), "assets/red_car.png", P1_CONTROLS)
player2 = Car((2293, 5956), "assets/white_car.png", P2_CONTROLS)
...
while True:
    for e in pygame.event.get():
        ...
        if show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            for car, pos in zip([player1, player2], [(2004, 5859), (2293, 5956)]):
