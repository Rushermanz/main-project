...
class Car(pygame.sprite.Sprite):
    def __init__(self, pos, group, image_path, angle=255):
...
class PlayerCar(Car):
    def __init__(self, pos, group):
        super().__init__(pos, group, "assets/red_car.png", angle=255)
...
class GhostBotCar(Car):
    def __init__(self, group, data, image_path, start_pos):
        first = data[0]
        super().__init__(start_pos, group, image_path, angle=255)
        self.data = data
        self.frame = 0
        self.lap_count = 1
        self.total_laps = 3
...
with open("usa_bot1_run.json") as f1, \
     open("usa_bot2_run.json") as f2, \
     open("usa_bot3_run.json") as f3:
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 255)
...
player = PlayerCar((2004, 5859), camera_group)
ghost_bot1 = GhostBotCar(camera_group, ghost_data1, "assets/white_car.png", start_pos=(2470, 5901))
ghost_bot2 = GhostBotCar(camera_group, ghost_data2, "assets/purple_car.png", start_pos=(2293, 5956))
ghost_bot3 = GhostBotCar(camera_group, ghost_data3, "assets/grey_car.png", start_pos=(2190, 5800))
...
while True:
    for e in pygame.event.get():
        ...
        if camera_group.show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            player.pos = pygame.Vector2(2004, 5859); player.angle = 255; player.speed = 0
            reset_positions = [(2470, 5901), (2293, 5956), (2190, 5800)]
