...
class Car(pygame.sprite.Sprite):
    def __init__(self, pos, image_path, controls, angle=305):
        super().__init__()
...
# Assets
track_surface = scale_image(pygame.image.load("assets/baku.png").convert_alpha(), 4.7)
border_surface = scale_image(pygame.image.load("assets/baku_border.png").convert_alpha(), 4.7)
drs_surface = scale_image(pygame.image.load("assets/baku_drs.png").convert_alpha(), 4.7)
finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 305)
...
finish_rect = finish_img.get_rect(center=(7252,2438))

# Players
player1 = Car((7460, 2368), "assets/red_car.png", P1_CONTROLS)
player2 = Car((7646, 2237), "assets/white_car.png", P2_CONTROLS)
...
while True:
    for e in pygame.event.get():
        ...
        if show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            for car, pos in zip([player1, player2], [(7460, 2368), (7646, 2237)]):
