...
class Car(pygame.sprite.Sprite):
    def __init__(self, pos, group, image_path, angle=215):
...
class PlayerCar(Car):
    def __init__(self, pos, group):
        super().__init__(pos, group, "assets/red_car.png", angle=215)
...
class GhostBotCar(Car):
    def __init__(self, group, data, image_path, start_pos):
        first = data[0]
        super().__init__(start_pos, group, image_path, angle=215)
        self.data = data
        self.frame = 0
        self.lap_count = 1
        self.total_laps = 3
...
with open("silverstone_bot1_run.json") as f1, \
     open("silverstone_bot2_run.json") as f2, \
     open("silverstone_bot3_run.json") as f3:
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 215)
...
player = PlayerCar((2955, 968), camera_group)
ghost_bot1 = GhostBotCar(camera_group, ghost_data1, "assets/white_car.png", start_pos=(3103, 1325))
ghost_bot2 = GhostBotCar(camera_group, ghost_data2, "assets/purple_car.png", start_pos=(3108, 1178))
ghost_bot3 = GhostBotCar(camera_group, ghost_data3, "assets/grey_car.png", start_pos=(2964, 1127))
...
while True:
    for e in pygame.event.get():
        ...
        if camera_group.show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            player.pos = pygame.Vector2(2955, 968); player.angle = 215; player.speed = 0
            reset_positions = [(3103, 1325), (3108, 1178), (2964, 1127)]
