...
class Car(pygame.sprite.Sprite):
    def __init__(self, pos, image_path, controls, angle=215):
        super().__init__()
...
# Assets
track_surface = scale_image(pygame.image.load("assets/british.png").convert_alpha(), 8.7)
border_surface = scale_image(pygame.image.load("assets/british_border.png").convert_alpha(), 8.7)
drs_surface = scale_image(pygame.image.load("assets/british_drs.png").convert_alpha(), 8.7)
finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 215)
...
finish_rect = finish_img.get_rect(center=(2800,821))

# Players
player1 = Car((2955, 968), "assets/red_car.png", P1_CONTROLS)
player2 = Car((3103, 1325), "assets/white_car.png", P2_CONTROLS)
...
while True:
    for e in pygame.event.get():
        ...
        if show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            for car, pos in zip([player1, player2], [(2955, 968), (3103, 1325)]):
