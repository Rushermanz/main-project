...
# Assets
track_surface = scale_image(pygame.image.load("assets/spain.png").convert_alpha(), 4.7)
border_surface = scale_image(pygame.image.load("assets/spain_border.png").convert_alpha(), 4.7)
drs_surface = scale_image(pygame.image.load("assets/spain_drs.png").convert_alpha(), 4.7)
finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 90)
...
finish_rect = finish_img.get_rect(center=(5974,3032))

# Players
player1 = Car((5600, 3095), "assets/red_car.png", P1_CONTROLS)
player2 = Car((5096, 2964), "assets/white_car.png", P2_CONTROLS)
...
while True:
    for e in pygame.event.get():
        ...
        if show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            for car, pos in zip([player1, player2], [(5600, 3095), (5096, 2964)]):
