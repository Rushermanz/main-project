...
# Insert this script's own directory into sys.path so `from utils import` works
# regardless of the working directory (which server.py sets to BASE_DIR).
...
with open("spain_bot1_run.json") as f1, \
     open("spain_bot2_run.json") as f2, \
     open("spain_bot3_run.json") as f3:
...
class CameraGroup(pygame.sprite.Group):
    def __init__(self):
        ...
        self.track_surface = scale_image(pygame.image.load("assets/spain.png").convert_alpha(), 4.7)
        self.border_surface = scale_image(pygame.image.load("assets/spain_border.png").convert_alpha(), 4.7)
        self.drs_surface = scale_image(pygame.image.load("assets/spain_drs.png").convert_alpha(), 4.7)
        self.finish_img = pygame.transform.rotate(scale_image(pygame.image.load("assets/finish.png").convert_alpha(), 2.4), 90)
...
player = PlayerCar((5600, 3095), camera_group)
ghost_bot1 = GhostBotCar(camera_group, ghost_data1, "assets/white_car.png", start_pos=(5096, 2964))
ghost_bot2 = GhostBotCar(camera_group, ghost_data2, "assets/purple_car.png", start_pos=(5235, 3094))
ghost_bot3 = GhostBotCar(camera_group, ghost_data3, "assets/grey_car.png", start_pos=(5407, 2970))
...
while True:
    for e in pygame.event.get():
        ...
        if camera_group.show_result and e.type == pygame.KEYDOWN and e.key == pygame.K_RETURN:
            player.pos = pygame.Vector2(5600, 3095); player.angle = 90; player.speed = 0
            reset_positions = [(5096, 2964), (5235, 3094), (5407, 2970)]
