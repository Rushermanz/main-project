...
class MovementRecorder:
    ...
    def save_to_file(self, filename="spain_player_run.json"):
...
class Track(pygame.sprite.Sprite):
    def __init__(self, pos, group):
        ...
        self.image = scale_image(pygame.image.load('assets/spain.png').convert_alpha(), 4.7)
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN and event.key == pygame.K_s:
            recorder.save_to_file("spain_player_run.json")
